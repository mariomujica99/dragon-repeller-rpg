...
function attack() {
    ...
    //getting a random number between 1 and the value of xp.
    //random number between 0-1. mult by xp. floor the num. add 1.
    ...
    if (health <= 0) {
        ...
        /*
        == compare equality after type conversions
        === does not perfom type conversions. both values have to be the exact same type.
        if (fighting === 2) {
            winGame();
        } else {
            defeatMonster();
